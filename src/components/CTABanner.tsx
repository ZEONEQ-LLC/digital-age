export default function CTABanner() {
  return (
    <>
      ...
      `}</style>
      <section style={{ backgroundColor: "var(--da-green)", margin: "64px 0 0", padding: "64px 32px" }}>
        <div className="cta-inner" style={{ maxWidth: "1200px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "32px" }}>
          <div>
            <h2 style={{ color: "var(--da-dark)", fontSize: "32px", fontWeight: 700, marginBottom: "12px" }}>
              Publiziere deinen KI-Content auf digital age
            </h2>
            <p style={{ color: "var(--da-dark)", fontSize: "16px", lineHeight: 1.6, maxWidth: "600px", opacity: 0.8 }}>
          ...
          <a href="/kontakt" style={{ backgroundColor: "var(--da-dark)", color: "var(--da-green)", fontSize: "16px", fontWeight: 600, padding: "16px 32px", borderRadius: "4px", textDecoration: "none", flexShrink: 0, whiteSpace: "nowrap" }}>
