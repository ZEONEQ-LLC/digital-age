      ...
      <footer style={{ backgroundColor: "#111113", borderTop: "1px solid #2a2a2e", marginTop: "0" }}>
        <div className="footer-wrapper" style={{ maxWidth: "1200px", margin: "0 auto", padding: "64px 32px 32px" }}>
          <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: "48px", marginBottom: "48px" }}>
            {/* Logo + Description */}
            <div>
              <img src="/images/digital age Logo green dark bg.png" alt="digital age" style={{ height: "48px", width: "auto", marginBottom: "20px" }} />
              <p style={{ color: "#b0b0b0", fontSize: "14px", lineHeight: 1.7, maxWidth: "320px" }}>
              ...
              <a href="https://www.linkedin.com/company/digital-age-schweiz" target="_blank" rel="noopener noreferrer"
                style={{ display: "inline-flex", alignItems: "center", gap: "8px", color: "#32ff7e", fontSize: "14px", fontWeight: 600, textDecoration: "none", marginTop: "20px" }}>
            ...
            {/* Themen */}
            <div>
              <h4 style={{ color: "#ffffff", fontSize: "13px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "20px" }}>Themen</h4>
              <nav style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                {[
                  ...
                  <a key={label} href={href} style={{ color: "#b0b0b0", fontSize: "14px", textDecoration: "none", transition: "color 0.2s" }}
                    onMouseEnter={e => (e.currentTarget.style.color = "#32ff7e")}
            ...
            {/* Über uns */}
            <div>
              <h4 style={{ color: "#ffffff", fontSize: "13px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "20px" }}>Über uns</h4>
              <nav style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                {[
          ...
          {/* Bottom bar */}
          <div style={{ borderTop: "1px solid #2a2a2e", paddingTop: "32px" }}>
