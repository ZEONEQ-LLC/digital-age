...
export default function ShareButtons({ title, url }: { title: string; url: string }) {
  ...
  const btnStyle: React.CSSProperties = {
    ...
    backgroundColor: "#2a2a2e", color: "#e0e0e0",
    border: "1px solid #3a3a3e", cursor: "pointer",
    textDecoration: "none", transition: "all 0.2s",
  };

  return (
    <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap" }}>
      <span style={{ color: "#b0b0b0", fontSize: "13px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em" }}>Teilen:</span>
      ...
      <button onClick={handleCopy} style={{ ...btnStyle, backgroundColor: copied ? "#32ff7e" : "#2a2a2e", color: copied ? "#1c1c1e" : "#e0e0e0" }} aria-label="Link kopieren">
        {copied ? (
