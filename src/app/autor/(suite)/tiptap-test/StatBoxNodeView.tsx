...
// Editor-View für StatBox-Block: 3-Spalten-Grid, pro Item value-Input
// (orange, Display-Font, gross) + label-Textarea darunter. Schreibt
// zurück auf node.attrs.items via updateAttributes — Tiptap re-rendert
// den Node, sodass die nächste Serialisierung den aktuellen Stand kennt.
