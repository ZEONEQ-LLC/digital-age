...
const inputStyle: React.CSSProperties = { width: "100%", backgroundColor: "var(--da-dark)", color: "var(--da-text)", border: "1px solid var(--da-border)", borderRadius: "4px", padding: "12px 16px", fontSize: "15px", fontFamily: "Inter, sans-serif", boxSizing: "border-box" };
...
const hintStyle: React.CSSProperties = { color: "var(--da-muted-soft)", fontSize: "12px", marginTop: "4px" };
    ...
    <main style={{ paddingTop: "64px", backgroundColor: "var(--da-dark)", minHeight: "100vh" }}>
      ...
      <section style={{ maxWidth: "720px", margin: "0 auto", padding: "48px 32px" }}>
        <div style={{ textAlign: "center", marginBottom: "16px" }}>
          <p style={{ color: "var(--da-green)", fontSize: "12px", fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "12px" }}>Schritt 2 von 2</p>
          <h1 style={{ color: "var(--da-text)", fontSize: "32px", fontWeight: 700, fontFamily: "Space Grotesk, sans-serif", marginBottom: "12px" }}>Dein Autoren-Profil</h1>
          <p style={{ color: "var(--da-muted)", fontSize: "15px", lineHeight: 1.5 }}>Diese Informationen werden auf deiner öffentlichen Autorenseite angezeigt (nach Freischaltung).</p>
        </div>
        ...
        <form style={{ backgroundColor: "var(--da-card)", border: "1px solid var(--da-border)", borderRadius: "8px", padding: "32px" }}>
          ...
          <h3 style={{ color: "var(--da-text)", fontSize: "18px", fontWeight: 600, marginBottom: "20px" }}>Persönlich</h3>
          ...
          <div style={groupStyle}>
            ...
            <div style={{ border: "2px dashed var(--da-border)", borderRadius: "8px", padding: "32px", textAlign: "center", cursor: "pointer" }}>
              <p style={{ color: "var(--da-muted)", fontSize: "14px" }}>📷 Foto hochladen</p>
              <p style={{ color: "var(--da-muted-soft)", fontSize: "12px", marginTop: "4px" }}>JPG oder PNG, mind. 400×400px</p>
            </div>
          </div>
          <div style={groupStyle}>
          ...
          <h3 style={{ color: "var(--da-text)", fontSize: "18px", fontWeight: 600, margin: "32px 0 20px" }}>Expertise</h3>
          <div style={groupStyle}>
            <label style={labelStyle}>Themenbereiche * (mehrfach möglich)</label>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", marginTop: "8px" }}>
              {expertiseAreas.map(area => (
                <label key={area} style={{ display: "inline-flex", alignItems: "center", gap: "6px", backgroundColor: "var(--da-dark)", border: "1px solid var(--da-border)", borderRadius: "4px", padding: "8px 12px", cursor: "pointer", fontSize: "13px", color: "var(--da-text-strong)" }}>
                  <input type="checkbox" />
                  {area}
                </label>
              ))}
          ...
          <div style={groupStyle}>
            ...
            <div style={{ display: "flex", gap: "12px", marginTop: "8px" }}>
              {["Deutsch", "English", "Français", "Italiano"].map(lang => (
                <label key={lang} style={{ display: "inline-flex", alignItems: "center", gap: "6px", cursor: "pointer", color: "var(--da-text-strong)", fontSize: "14px" }}>
                  <input type="checkbox" />
                  {lang}
                </label>
              ))}
          ...
          <h3 style={{ color: "var(--da-text)", fontSize: "18px", fontWeight: 600, margin: "32px 0 20px" }}>Online-Präsenz</h3>
          <div style={groupStyle}>
          ...
          <h3 style={{ color: "var(--da-text)", fontSize: "18px", fontWeight: 600, margin: "32px 0 20px" }}>Motivation</h3>
          <div style={groupStyle}>
          ...
          <button type="button" onClick={() => window.location.href = "/autor/wartezimmer"} style={{ backgroundColor: "var(--da-green)", color: "var(--da-dark)", border: "none", padding: "14px", borderRadius: "4px", fontSize: "15px", fontWeight: 700, cursor: "pointer", width: "100%" }}>Profil zur Prüfung einreichen →</button>

          <p style={{ color: "var(--da-muted-soft)", fontSize: "12px", lineHeight: 1.5, marginTop: "16px", textAlign: "center" }}>Platzhalter – Profil-Speicherung folgt mit Supabase</p>
        </form>
      </section>
      <Footer />
    </main>
