    ...
    <main style={{ paddingTop: "64px", backgroundColor: "var(--da-dark)", minHeight: "100vh" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div className="author-hero">
            ...
            <div>
              ...
              <p style={{ color: "var(--da-muted)", fontSize: "18px", marginBottom: "24px" }}>{author.role}</p>
              ...
              <div className="author-stats" style={{ marginBottom: "24px" }}>
                <div>
                  <p style={{ color: "var(--da-green)", fontSize: "32px", fontWeight: 700, fontFamily: "Space Grotesk, sans-serif", lineHeight: 1 }}>{authorArticles.length}</p>
              ...
              <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                {author.linkedin && (
                  <a href={author.linkedin} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: "8px", backgroundColor: "var(--da-card)", border: "1px solid var(--da-border)", color: "var(--da-text-strong)", padding: "10px 18px", borderRadius: "4px", textDecoration: "none", fontSize: "14px", fontWeight: 500 }}>
      ...
      <section style={{ maxWidth: "1200px", margin: "0 auto", padding: "64px 32px" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "32px", borderBottom: "1px solid var(--da-border)", paddingBottom: "16px" }}>
          ...
          <span style={{ color: "var(--da-muted)", fontSize: "14px" }}>{authorArticles.length} Artikel</span>
        </div>
