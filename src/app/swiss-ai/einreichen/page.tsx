    ...
    <main style={{ paddingTop: "64px", backgroundColor: "var(--da-dark)", minHeight: "100vh" }}>
      ...
      <section style={{ maxWidth: "720px", margin: "0 auto", padding: "48px 32px" }}>
        <form style={{ backgroundColor: "var(--da-card)", border: "1px solid var(--da-border)", borderRadius: "8px", padding: "32px" }}>
          <h3 style={{ color: "var(--da-text)", fontSize: "18px", fontWeight: 600, marginBottom: "20px" }}>Unternehmens-Info</h3>
          ...
          <h3 style={{ color: "var(--da-text)", fontSize: "18px", fontWeight: 600, margin: "32px 0 20px" }}>Klassifizierung</h3>
          ...
          <h3 style={{ color: "var(--da-text)", fontSize: "18px", fontWeight: 600, margin: "32px 0 20px" }}>Kontakt</h3>
          ...
          <button type="button" style={{ backgroundColor: "var(--da-green)", color: "var(--da-dark)", border: "none", padding: "14px 32px", borderRadius: "4px", fontSize: "15px", fontWeight: 700, cursor: "pointer", width: "100%" }}>
            Zur Prüfung einreichen →
          </button>

          <p style={{ color: "var(--da-muted-soft)", fontSize: "12px", lineHeight: 1.5, marginTop: "16px", textAlign: "center" }}>
